function AnalogClock({ seconds, minutes, hours }) {
  ...
  return (
    <div
      id="analog-clock"
      className="flex aspect-square w-8/12 min-w-80 items-center justify-center rounded-full bg-gradient-to-t from-yellow-200 via-peach-200 to-pink-200 drop-shadow-xl"
    >
      <div
        id="analog-face"
        className="relative flex size-10/12 items-center justify-center rounded-full bg-neutral-100 shadow-xl"
      >
